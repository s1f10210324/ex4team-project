...
urlpatterns = [
    ...
    path('accounts/new/', views.new, name='new'),
    ...
    path('<int:subject_id>/quiz/<int:quiz_id>/ex', views.ex, name='ex'),
    path('<int:subject_id>/quiz/correct', views.correct, name='correct'),
    path('<int:subject_id>/quiz/wrong', views.wrong, name='wrong'),
]